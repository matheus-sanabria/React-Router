...
const AddProfessional = () => {
    const [professional_photo, setProfessional_photo] = useState('')
    const [professional_name, setProfessional_name] = useState('')
    const [professional_phone, setProfessional_phone] = useState('')
    const [professional_email, setProfessional_email] = useState('')
    const [professional_birthDay, setProfessional_birthDay] = useState('')
    const [professional_birthMonth, setProfessional_birthMonth] = useState('')
    const [professional_obs, setProfessional_obs] = useState('')
    ...
    const handleImageUpload = (e) => {
        ...
        if (file) {
            ...
            reader.onload = (event) => {
                ...
                setProfessional_photo(imageData);
            };
    ...
    const Send = async e => {
        ...
        try {
            ...
            const res = await fetch('http://localhost:8081/professionals', {
                method: "POST",
                headers: {"Content-Type":"application/json"},
                body: JSON.stringify(data)
            })
            console.log("cheguei até aqui")
            window.location = '/profissionais'
        } catch (error) {
            console.log(error)
        }
    }
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h5 class="modal-title" id="exampleModalLabel">Adicionar professional</h5>
